...
<body class="outcome-2">
    ...
    <button><a href="#outcome-2-vibevault">1</a></button>
    <button><a href="#outcome-2-mediacampaign">2</a></button>
    <button><a href="#outcome-2-vibevault">3</a></button>


    <div class="outcome-body">
        <!-- Vibe Vault -->
        <div class="container text-dark" name="outcome-2-vibevault" id="outcome-2-vibevault">
            <div class="py-4"></div>
            <div class="row">
                <div class="col">
        ...
        <!-- Media Campaign -->
        <div class="container text-dark" name="outcome-2-mediacampaign" id="outcome-2-mediacampaign">
            <div class="py-4"></div>
            <div class="row">
                <div class="col">
