...
<body class="outcome-1">
    ...
    <button><a href="#outcome-1-vibevault">1</a></button>
    <button><a href="#outcome-1-mediacampaign">2</a></button>
    <button><a href="#outcome-1-vibevault">3</a></button>
