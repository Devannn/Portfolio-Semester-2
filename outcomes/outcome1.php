...
<body class="outcome-3">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                <li class="nav-item ml-5">
                    <a class="nav-link text-white" href="" id="projectLink">Learning Outcome 1</a>
                </li>
            </ul>
        ...
        <div class="container pt-4 buttons-container">
            <div class="row">
                <div class="col">
                    ...
                    <button type="button" class="btn btn-outline-secondary">
                        <a class="btn text-secondary" href="#outcome-1-vibevault" role="button">Coding Fontys</a>
                    </button>
                    <button type="button" class="btn btn-outline-secondary">
    ...
    <div class="outcome-body">
        ...
        <!-- Portfolio -->
        <div class="container text-dark pt-4" name="outcome-1-portfolio" id="outcome-1-portfolio">
            <div class="row">
                <div class="col">
