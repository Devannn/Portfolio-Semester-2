...
<body>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu text-uppercase" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item text-uppercase" href="outcome1.php">Interactive Media Products</a>
                        <a class="dropdown-item text-uppercase" href="outcome2.php">Development And Version Control</a>
                        <a class="dropdown-item text-uppercase" href="outcome3.php">Iterative Design</a>
                        <a class="dropdown-item text-uppercase" href="outcome4.php">Professional Standard</a>
                        <a class="dropdown-item text-uppercase" href="outcome5.php">Personal Leadership</a>
                    </div>
                </li>
    ...
    <div id="carousel" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active" id="carousel-item1">
                <a href="projects.php">
                    <img src="img/vibevault-image.png" class="d-block w-100" alt="Slide 1">
                </a>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var projectLinks = {
                'carousel-item1': 'project1.php',
                'carousel-item2': 'project2.php',
                'carousel-item3': 'project3.php'
            };
